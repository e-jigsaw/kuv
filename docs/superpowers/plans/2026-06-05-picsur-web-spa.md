...
- [ ] **Step 2: test script の更新 — `packages/web/package.json`**

`"test": "vitest run --passWithNoTests"` を `"test": "vitest run"` に変更。

- [ ] **Step 3: vitest 設定 — `packages/web/vitest.config.ts`（新規）**
...
- [ ] **Step 4: dev proxy — `packages/web/vite.config.ts`**
...
- [ ] **Step 1: 失敗するテストを書く — `packages/web/lib/api.test.ts`**
...
- [ ] **Step 3: 実装 — `packages/web/lib/api.ts`**
...
- [ ] **Step 1: ガード実装 — `packages/web/pages/+guard.ts`（新規）**
...
- [ ] **Step 2: Layout にヘッダーナビ + logout — `packages/web/pages/+Layout.tsx`**
...
- [ ] **Step 1: 失敗するテストを書く — `packages/web/components/LoginForm.test.tsx`**
...
- [ ] **Step 3: 実装 — `packages/web/components/LoginForm.tsx`**
...
- [ ] **Step 4: ページの皮 — `packages/web/pages/login/+Page.tsx`（新規）**
...
- [ ] **Step 1: 失敗するテストを書く — `packages/web/components/HomePage.test.tsx`**
...
- [ ] **Step 3: 実装 — `packages/web/components/HomePage.tsx`**
...
- [ ] **Step 4: ページの皮 — `packages/web/pages/index/+Page.tsx`**
...
- [ ] **Step 1: 失敗するテストを書く — `packages/web/components/ImageView.test.tsx`**
...
- [ ] **Step 3: 実装 — `packages/web/components/ImageView.tsx`**
...
- [ ] **Step 4: ページの皮 — `packages/web/pages/image/@id/+Page.tsx`（新規）**
...
- [ ] **Step 5: prerender を partial に — `packages/web/pages/+config.ts`**
...
- [ ] **Step 1: 失敗するテストを書く (a) — `packages/web/components/KeepOriginalToggle.test.tsx`**
...
- [ ] **Step 2: 失敗するテストを書く (b) — `packages/web/components/ApikeyManager.test.tsx`**
...
- [ ] **Step 3: 失敗するテストを書く (c) — `packages/web/components/PasswordForm.test.tsx`**
...
- [ ] **Step 5: 実装 (a) — `packages/web/components/KeepOriginalToggle.tsx`**
...
- [ ] **Step 6: 実装 (b) — `packages/web/components/ApikeyManager.tsx`**
...
- [ ] **Step 7: 実装 (c) — `packages/web/components/PasswordForm.tsx`**
...
- [ ] **Step 8: ページの皮 — `packages/web/pages/settings/+Page.tsx`（新規）**
